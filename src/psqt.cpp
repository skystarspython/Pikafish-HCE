...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2 + 1] = {
  ...
  { // ROOK
   ...
   { S( -46, -43), S( 180, -10), S( 127, -41), S( 429, 135), S( -77, 218)},
  ...
  { // CANNON
   ...
   { S(  47,-211), S(  90, -84), S( 128, -43), S(  21,  62), S( 654, 156)},
   { S( -20,-133), S( -37, 133), S(  12, -23), S(  57, -99), S( 351,  69)},
   { S( -28, 105), S( -54,   3), S(  20,  18), S( -64, -85), S( 161,  66)},
   { S( 189, -49), S( 225, -15), S( 220,  20), S(   3, 114), S(-318,  -3)}
  },
  { // PAWN
   { S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0)},
   { S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0)},
  ...
  { // KNIGHT
   ...
   { S(  26, -87), S(-100,  78), S(-133, -16), S( 125, -97), S(-1245,-318)},
