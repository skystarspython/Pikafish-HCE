...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2 + 1] = {
  ...
  { // ROOK
   ...
   { S(-148, 135), S( 150, -78), S( 254, -29), S(  51,  11), S( 122,  78)},
  ...
  { // PAWN
   ...
   { S( -19,  93), S( -57,  91), S( 123,  58), S( 230, 199), S( 276,  52)},
  ...
  { // KNIGHT
   ...
   { S(-126, -87), S(-100,  78), S(-133, -16), S( 125, -97), S(-445,-218)},
   { S(-108,-119), S(  50, -69), S( 301, -91), S( -21,  16), S(  14,   8)},
  ...
  { // BISHOP
   ...
   { S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0)},
   { S(  12,  81), S(   0,   0), S(   0,   0), S(   0,   0), S(  26, 159)},
   { S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0)},
