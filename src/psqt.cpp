...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2 + 1] = {
  { },
  { // ROOK
   { S(-218,-132), S(  44,-242), S(  -3, -73), S( -31,  -5), S(   7, -45)},
   ...
   { S(-148, 135), S( -20, -78), S( 154, -29), S(  51,  11), S( 122,  78)},
  ...
  { // ADVISOR
   { S(   0,   0), S(   0,   0), S(   0,   0), S( -22,  44), S(   0,   0)},
   { S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0), S(   2, 119)},
  ...
  { // PAWN
   ...
   { S( -19,  93), S( -57,  91), S( 123,  58), S( 130, 199), S( 276,  52)},
   { S( -80,  64), S(-160, 102), S( 135, 178), S(  21, 196), S(  97, 120)},
   { S(  88, -87), S(-133,  83), S(  26, 216), S( 119,  33), S(-132, 165)},
   { S(-176,-149), S(  35,  42), S( 191,  23), S( 200, 150), S( 274, 300)},
   { S( -99, -54), S(  82, -95), S( -79,  10), S(  28, -19), S(  27,-100)}
  },
  { // KNIGHT
   { S( -18, -23), S(-183,-252), S( -18, -38), S(-136,-152), S( -81,  43)},
   { S(-126, -87), S(-100,  78), S(-133, -16), S( -25, -97), S(-345,-118)},
   { S(-108,-119), S(  50, -69), S( 101, -91), S( -21,  16), S(  14,   8)},
   ...
   { S(-102, -45), S( -83, -44), S( 135, 158), S( -59, -66), S( 155, 121)},
   { S( -28,  31), S(  23, 139), S(  22,   7), S(-132, -75), S( -58,  45)}
  },
  { // BISHOP
   { S(   0,   0), S(   0,   0), S(  48, 134), S(   0,   0), S(   0,   0)},
   { S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0)},
