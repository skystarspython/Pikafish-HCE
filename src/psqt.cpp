...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2 + 1] = {
  ...
  { // CANNON
   ...
   { S( 134, -62), S(  57, -17), S( 296,  93), S( -79,  88), S( 246,  66)},
   ...
   { S(  47,-211), S(  90, -84), S( 228, -43), S(  21,  62), S( 554, 156)},
  ...
  { // PAWN
   ...
   { S( 115,   8), S(   0,   0), S(  57, -17), S(   0,   0), S( 182,  31)},
  ...
  { // KNIGHT
   ...
   { S( 158,-119), S(  50, -69), S( 301, -91), S( 121,  16), S( 214,   8)},
