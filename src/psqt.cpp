...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2 + 1] = {
  ...
  { // CANNON
   ...
   { S(  47,-211), S(  90, -84), S(  28, -43), S(  21,  62), S( 254, 156)},
  ...
  { // PAWN
   ...
   { S( -19,  93), S( -57,  91), S( 123,  58), S( 130, 199), S(  76,  52)},
  ...
  { // KNIGHT
   ...
   { S(-126, -87), S(-100,  78), S(-133, -16), S( -25, -97), S(-245,-118)},
  ...
  { // KING
   { S(   0,   0), S(   0,   0), S(   0,   0), S(  55,  36), S( 245,  90)},
