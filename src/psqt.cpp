...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2 + 1] = {
  { },
  { // ROOK
   { S(-218,-132), S( 244,-242), S(  -3, -73), S( 331,  -5), S(-407, -45)},
   ...
   { S(-148, 135), S( 280, -78), S( 554, -29), S( 451,  11), S( 122,  78)},
  ...
  { // CANNON
   ...
   { S( -24, -27), S(-113,  48), S(-105,  11), S( -93, 102), S( 248, -35)},
   { S( -68,  -4), S(  31, -87), S(   5,  39), S( -11,  19), S( 292,  76)},
   { S(  47,-211), S(  90, -84), S( 228, -43), S(  21,  62), S( 654, 156)},
  ...
  { // PAWN
   ...
   { S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0)},
   { S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0)},
   { S(  -8,   1), S(   0,   0), S(-106, -32), S(   0,   0), S( 100,  30)},
