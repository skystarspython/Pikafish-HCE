...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2 + 1] = {
  ...
  { // CANNON
   ...
   { S(  47,-211), S(  70, -84), S( 258, -43), S(  21,  62), S( 554, 156)},
  ...
  { // PAWN
   ...
   { S( 119,  93), S( 157,  91), S( 153,  58), S( 230, 199), S( 276,  52)},
  ...
  { // KNIGHT
   ...
   { S( 126, -87), S(-100,  78), S(-133, -16), S( 125, -97), S(-445, -18)},
   { S( 158,-119), S(  50, -69), S( 201, -91), S( 121,  16), S( 214,   8)},
  ...
  { // BISHOP
   ...
   { S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0)},
   { S(  12,  81), S(   0,   0), S(   0,   0), S(   0,   0), S( 266, 159)},
   { S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0)},
