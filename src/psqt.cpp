...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2 + 1] = {
  { },
  { // ROOK
   { S(-218,-132), S( 144,-242), S(  -3, -73), S( 331,  -5), S(-407, -45)},
   { S(   1, -25), S(   6, -45), S( -71,-123), S(  96, 122), S(-107, 101)},
   { S(-157, -20), S(   5, -83), S( -39,  47), S(   2,   6), S( -20,  46)},
   { S( -31,  77), S( -14, -53), S( -71,  50), S(   9,  49), S( -66, -20)},
   { S( -91,  27), S( 128,  -6), S(-114,  19), S(   8,  18), S(-165,  -6)},
   { S( -41,  -7), S( 237,  30), S(  86, -55), S(  80, -84), S( 118,  65)},
   { S(-148, 135), S( 280, -78), S( 454, -29), S( 451,  11), S( 122,  78)},
   { S( 145, 150), S(  53,-137), S(  92, 122), S( 288,  93), S( 252, -38)},
   { S( -46, -43), S( 380, -10), S( 127, -41), S( 529, 135), S( -77, 218)},
   { S( 116, -64), S(  67, -68), S(  77,   0), S( 118,  58), S( 110,  34)}
  },
  { // ADVISOR
   { S(   0,   0), S(   0,   0), S(   0,   0), S(  -2,  44), S(   0,   0)},
   { S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0), S( 152, 119)},
   { S(   0,   0), S(   0,   0), S(   0,   0), S( -85,  75), S(   0,   0)},
  ...
  { // CANNON
   ...
   { S( 126,  -5), S(  45, -41), S( 368,   7), S(  78,  22), S(  99,  29)},
   { S( 134, -62), S(  57, -17), S( 296,  93), S(  79,  88), S( 266,  66)},
   { S(  -5,  77), S(-217, -20), S( 117,  84), S(  76,-153), S( 119, -66)},
   { S( -24, -27), S(-113,  48), S(-105,  11), S( -93, 102), S( 348, -35)},
   { S( -68,  -4), S(  31, -87), S(   5,  39), S( -11,  19), S(  92,  76)},
   { S(  47,-211), S(  90, -84), S( 128, -43), S(  21,  62), S( 554, 156)},
   { S( -20,-133), S( -37, 133), S(  12, -23), S(  57, -99), S( 351,  69)},
   { S( -28, 105), S( -54,   3), S(  20,  18), S( -64, -85), S( 161,  66)},
   { S( 289, -49), S( 225, -15), S( 220,  20), S(   3, 114), S(-318,  -3)}
  },
  { // PAWN
   { S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0)},
   { S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0)},
   ...
   { S( 115,   8), S(   0,   0), S(  87, -17), S(   0,   0), S( 182,  31)},
   { S( 119,  93), S( 157,  91), S( 323, 158), S( 230, 199), S( 276,  52)},
  ...
  { // KNIGHT
   ...
   { S( 158,-119), S(  50, -69), S( 281, -91), S( 121,  16), S( 214,   8)},
   { S(  25,   7), S( -72,-116), S( 220,  -7), S(   4, -87), S(  81,  87)},
   { S(-123,  15), S( 224, 129), S( -22,  88), S( 119,-103), S(  69,  61)},
  ...
  { // BISHOP
   ...
   { S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0)},
   { S(   0,   0), S(   0,   0), S(-213,  86), S(   0,   0), S(   0,   0)},
   { S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0)},
   { S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0)},
   { S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0)},
   { S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0)},
  ...
  { // KING
   { S(   0,   0), S(   0,   0), S(   0,   0), S(  85, 336), S( 145,  90)},
   { S(   0,   0), S(   0,   0), S(   0,   0), S(-216,  -3), S(-160,  80)},
   { S(   0,   0), S(   0,   0), S(   0,   0), S(-232,-131), S(-224, -66)},
   { S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0)},
   { S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0)},
   { S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0)},
   { S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0), S(   0,   0)},
