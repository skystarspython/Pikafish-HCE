...
constexpr Score Bonus[][RANK_NB][int(FILE_NB) / 2 + 1] = {
  ...
  { // ROOK
   ...
   { S( -41,  -7), S( 137,  30), S(  86, -55), S(  80, -84), S( 118,  65)},
   { S(-148, 135), S( 210, -78), S( 454, -29), S( 451,  11), S( 122,  78)},
  ...
  { // CANNON
   ...
   { S( 134, -62), S(  57, -17), S( 356,  93), S(  79,  88), S( 266,  66)},
   { S(  -5,  77), S(-217, -20), S( 117,  84), S(  76,-153), S( 119, -66)},
   { S( -24, -27), S(-113,  48), S(-105,  11), S( -93, 102), S( 358, -35)},
   { S( -68,  -4), S(  31, -87), S(   5,  39), S( -11,  19), S(  92,  76)},
   { S(  47,-211), S(  90, -84), S( 328, -43), S(  21,  62), S( 554, 156)},
  ...
  { // PAWN
   ...
   { S( 119,  93), S( 157,  91), S( 223, 158), S( 230, 199), S( 276,  52)},
