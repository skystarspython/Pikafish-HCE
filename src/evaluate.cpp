...
#define S(mg, eg) make_score(mg, eg)
    ...
    constexpr Score mobilityBonus[PIECE_TYPE_NB][18] = {
        {}, // NO_PIECE_TYPE
        {S(-1211, -5951), S(162, -1811), S(-1440, -3777), S(0, -4067), S(-958, -6612), S(-1410, -5376), S(2265, -3655), S(256, -5429), S(4102, -3668), S(3992, -5875), S(6156, -4247), S(5851, 537), S(8672, -2370), S(10361, 996), S(11430, -3330), S(9853, 1940), S(11257, -1895), S(2240, -2813)}, // ROOK
        {S(3299, -6457), S(4881, 154), S(3976, -11), S(5589, 1976), S(8810, 521)}, // ADVISOR
        {S(460, 811), S(299, 2332), S(1612, 246), S(927, 4921), S(-1081, 3766), S(2439, 2282), S(128, 3093), S(-668, 2467), S(-2604, 3267), S(-904, 980), S(-1459, 3831), S(847, 5169), S(-1464, 5564), S(261, 6952), S(-2254, 7423), S(584, 7143), S(379, 7081), S(-1975, 5788)}, // CANNON
        {}, // PAWN
        {S(-1886, -6285), S(3330, -2660), S(4038, -3026), S(5920, 1740), S(3828, 3307), S(11632, 4989), S(7401, 2385), S(11937, 6966), S(13621, 7608)}, // KNIGHT
        {S(1672, -2150), S(1603, -3981), S(1171, -1728), S(5986, 331), S(9996, -2500)} // BISHOP
    };
#undef S
