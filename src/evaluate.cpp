...
#define S(mg, eg) make_score(mg, eg)
    ...
    constexpr Score mobilityBonus[PIECE_TYPE_NB][18] = {
        ...
        {}, // PAWN
        {S(-20582, -5894), S(2260, -2360), S(4002, -2435), S(6595, 1090), S(8389, 2949), S(15760, 3209), S(17500, 3453), S(19956, 6472), S(23619, 7657)}, // KNIGHT
...
Value Eval::evaluate(const Position& pos, int* complexity) {
  ...
  constexpr int rangeTable[] = {0, 2, 4, 8, 16, 32, 64};
  if(count > 0)
