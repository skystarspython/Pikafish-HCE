...
#define S(mg, eg) make_score(mg, eg)
    ...
    constexpr Score CentralKnight = S(700, 300);
    ...
    constexpr Score mobilityBonus[PIECE_TYPE_NB][18] = {
        {}, // NO_PIECE_TYPE
        {S(-3655, -3045), S(-423, -2895), S(-1144, -2170), S(-999, -3012), S(-867, -5183), S(-797, -3787), S(2637, -2581), S(3577, -3604), S(-412, -3371), S(-254, -5076), S(-18, -4178), S(229, -946), S(8410, -3079), S(9004, -1200), S(8081, -3500), S(9035, -1212), S(11433, -3483), S(11686, -4329)}, // ROOK
        {S(-3686, -4329), S(4461, 745), S(4657, 329), S(5853, 1929), S(9140, 275)}, // ADVISOR
        {S(-11672, 1629), S(-310, 1438), S(1799, 1728), S(840, 4456), S(115, 3069), S(1085, 3029), S(624, 3532), S(-1894, 3181), S(-1461, 3018), S(-461, 2196), S(-1398, 5107), S(568, 4268), S(-1408, 5591), S(-933, 5727), S(-2136, 6283), S(-478, 7094), S(35, 6741), S(-2309, 6672)}, // CANNON
        {}, // PAWN
        {S(-4582, -5894), S(2260, -2360), S(4002, -2435), S(4595, 1090), S(5389, 2949), S(9760, 3209), S(8500, 3453), S(11956, 6472), S(13619, 7657)}, // KNIGHT
