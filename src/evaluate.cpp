...
#define S(mg, eg) make_score(mg, eg)
    ...
    constexpr Score CentralKnight = S(-450, 53);
    ...
    constexpr Score mobilityBonus[PIECE_TYPE_NB][18] = {
        {}, // NO_PIECE_TYPE
        {S(-3655, -3045), S(-423, -2895), S(-1144, -2170), S(-999, -3012), S(-867, -5183), S(-797, -3787), S(-637, -2581), S(-577, -3604), S(-412, -3371), S(-254, -5076), S(-18, -4178), S(229, -946), S(8410, -3079), S(9004, -1200), S(8081, -3500), S(9035, -1212), S(11433, -3483), S(11686, -4329)}, // ROOK
        ...
        {}, // PAWN
        {S(-2582, -5894), S(2260, -2360), S(4002, -2435), S(4595, 1090), S(5389, 2949), S(9760, 3209), S(8500, 3453), S(11956, 6472), S(13619, 7657)}, // KNIGHT
